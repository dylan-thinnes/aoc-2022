...
++>> # init history of 14 twos, all with no uniqueness
++>>
++>>
++>>
++>>
...
[
  ...
  # Do 13 element check, copy differences as 0 (meaning zero) or 1 (meaning non-zero)
  >>>>>>>>>>>>>>+++++++++++++<<<<<<<<<<<<<<
  >[
   >>>>>>>>>>>>>-<<<<<<<<<<<<<
   ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++[-]
  ...
  # If any 13 elements aren't different, unset the unique bit, return uniqueness count to orig
  >[<<<<<<<<<<<<<<- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<->>>>>>>>>>>>>>>>>>>>>>>>>>>>> >>>>>>>>>>>>>>[-]]<<<<<<<<<<<<<<
  <
